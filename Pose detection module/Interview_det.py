...
def classifyPose(landmarks):
    ...
    # priqnt("Mid Point", mp)
    if (left_shoulder_angle>=10 and left_shoulder_angle<=50) and (right_shoulder_angle >= 310 and right_shoulder_angle <= 350):
        if (left_knee_angle >= 200 and left_knee_angle <= 250) and (right_knee_angle >= 110 and right_knee_angle <= 160):
            if(left_elbow_angle >= 190 and left_elbow_angle <= 230) and (right_elbow_angle >= 110 and right_elbow_angle <= 150):
                if(left_hip_angle >= 110 and left_hip_angle <= 150):
                        return points, True, "Good, sitting in an interview."
                else:
                    return points, False, "Adjust your hips."
            else:
                return points, False, "Adjust your elbows."
        else:
            return points,False, "Adjust your knees."

    else:
        return points,False,"Adjust your shoulders."
